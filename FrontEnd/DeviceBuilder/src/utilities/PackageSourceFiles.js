...
export const packageSourceFiles = (deviceDetails, controls) => {
  ...
  setIDAndMAC((deviceIDarray, MACAddressArray) => {
    ...
    zip.file('AutoGeneratedInfo.h', generateAutoInfoFile(deviceIDarray, MACAddressArray, physicalLayer));
...
const generateAutoInfoFile = (deviceIDarray, MACAddressArray, physicalLayer) => {
